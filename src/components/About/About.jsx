...
import profileImage from "../../assets/Puzan.jpg";
      ...
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          <p className="text-gray-400 text-base sm:text-lg md:text-lg mb-10 mt-8 leading-relaxed">
            ...
            JavaScript. I love creating beautiful and functional web
        ...
        <div className="md:w-1/2 flex justify-center md:justify-end ">
          <Tilt
            className="h-48 w-48 sm:w-64 sm:h-64 md:w-[30rem] md:h-[30rem] border-4 border-purple-700 rounded-full"
            tiltMaxAngleX={20}
            tiltMaxAngleY={20}
            perspective={1000}
            scale={1.05}
